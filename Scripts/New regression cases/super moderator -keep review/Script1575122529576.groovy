...
WebUI.setText(findTestObject('Object Repository/supermodetor reveiw/Page_theworklife - Find Great People To Work With/input_Forgot password_username'), 
    'supermoderator@thework.life')

WebUI.setEncryptedText(findTestObject('Object Repository/supermodetor reveiw/Page_theworklife - Find Great People To Work With/input_Forgot password_password'), 
    'brzxOZY6Pq6zd6YtOOpJEg==')

WebUI.click(findTestObject('Object Repository/supermodetor reveiw/Page_theworklife - Find Great People To Work With/button_Sign in'))

WebUI.click(findTestObject('Object Repository/supermodetor reveiw/Page_Report/button_Verify'))

WebUI.delay(3)

WebUI.setText(findTestObject('Object Repository/supermodetor reveiw/Page_Report/textarea_seems a flag so keeping it_txtRemark'), 
    'i think we should keep the review hwere klsfhklfhklf')

WebUI.click(findTestObject('Object Repository/supermodetor reveiw/Page_Report/button_Keep It'))
