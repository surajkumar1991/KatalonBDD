...
WebUI.setText(findTestObject('Object Repository/Rate/Page_Home/input_View all_searchText'), 'USER1575490010352')
...
WebUI.waitForElementClickable(findTestObject('Rate/Page_View Profile/span_Desire to work with again_star3'), 5)
...
WebUI.click(findTestObject('Rate/Page_View Profile/a_OK'))
