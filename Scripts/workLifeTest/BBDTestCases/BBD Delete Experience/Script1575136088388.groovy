...
WebUI.setText(findTestObject('Object Repository/Page_theworklife/input_Forgot password_username'), 'worklifetest10001@gmail.com')
...
WebUI.click(findTestObject('BDDFolder/EditExeperiece/Delete Button'))

WebUI.click(findTestObject('BDDFolder/EditExeperiece/Yes button'))
